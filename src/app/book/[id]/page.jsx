    ...
    try {
      const res = await fetch(`${SERVER_URL}/api/reader/purchase`, {
        ...
        body: JSON.stringify({
          ...
          writerName: book.writerName, date: new Date()
        })
      });
      if (res.ok) {
        toast.success("Purchased! Redirecting...", { id: toastId });
          ...
          <div className="flex-1 space-y-8">
             ...
             <div className="flex flex-wrap items-center gap-5 pt-6">
                ...
                <button 
                  ...
                  className={`h-16 lg:h-20 w-16 lg:w-20 rounded-[25px] flex items-center justify-center border transition-all ${
                    isBookmarked 
